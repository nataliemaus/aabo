...
# For the AABO repo, we copied this code from: 
#   https://app.codecov.io/gh/pytorch/botorch/pull/1652/blob/botorch/models/utils/inducing_point_allocators.py
#   https://app.codecov.io/gh/pytorch/botorch/pull/1652
r"""
